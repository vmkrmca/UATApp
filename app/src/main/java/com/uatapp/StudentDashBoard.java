...
public class StudentDashBoard extends Activity implements View.OnClickListener, RequestEventClickListener {
    ...
    public void onRequestClick(Event mEvent) {
        ...
        String eventID = mEvent.eventID;
        long id = mDbHelper.insertRequestEventDetails(eventID,emailAddress, mobileNumber, eventTitle, eventDate, eventTime,"false");

        if (id != -1) {

            mDbHelper.updateEventDetails(eventID,emailAddress,"false");
